...
<div align="center">
  ...
  &nbsp;
  <a href="https://github.com/anubh7">
...
I'm glad you're here. Feel free to explore my projects, check out my code, and connect with me.

---

### 👨‍💻 About Me

I'm a final-year Computer Science student who loves building **complete, real-world applications** — from clean frontends to solid backend systems and databases.

I focus on writing maintainable code, designing good APIs, and understanding how systems scale.

> 🚀 **Currently open to** Software Engineer / Full-Stack / Backend / Data Engineering roles (Internship & Full-time)
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>📈 SalesPulse</h3>
      <p>Full-stack Sales Analytics & Management System with JWT auth, role-based access, interactive dashboards, charts, Excel import/export, and complete CRUD for sales, products & customers.</p>
      <p>
      ...
      <a href="https://github.com/anubh7/SalesPulse"><b>→ View Project</b></a>
    </td>
    <td width="50%" valign="top">
      <h3>⚡ NexusHub</h3>
      <p>Full-stack social networking platform with authentication, posts, likes, comments, friend system, real-time notifications, analytics dashboard and dark mode.</p>
      <p>
        <img src="https://img.shields.io/badge/MERN-Stack-00C853?style=flat-square"/>
        <img src="https://img.shields.io/badge/JWT-Auth-2962FF?style=flat-square"/>
        <img src="https://img.shields.io/badge/Redux-Toolkit-7B1FA2?style=flat-square"/>
      </p>
      <a href="https://github.com/anubh7/Nexushub"><b>→ View Project</b></a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
